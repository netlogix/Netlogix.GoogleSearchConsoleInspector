...
var InspectorView = (_dec = (0, _neosUiViews.dataLoader)(), _dec(_class = (_temp = _class2 = function (_PureComponent) {
    ...
    function InspectorView() {
        _classCallCheck(this, InspectorView);

        return _possibleConstructorReturn(this, (InspectorView.__proto__ || Object.getPrototypeOf(InspectorView)).apply(this, arguments));
    }

    _createClass(InspectorView, [{
        key: 'render',
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    {
                        className: _style2.default.viewbutton,
                        style: 'lighter',
                ...
                _react2.default.createElement(
                    ...
                    { style: 'condensed' },
                    _react2.default.createElement(
                        _reactUiComponents.ToggablePanel.Header,
                        { className: _style2.default.panelheader },
                        _react2.default.createElement(_reactUiComponents.Icon, { icon: 'info', padded: 'right' }),
                        'Page Status'
                    ),
                    _react2.default.createElement(
                        _reactUiComponents.ToggablePanel.Contents,
                        { className: _style2.default.panelcontents },
                        _react2.default.createElement(
                            'div',
                ...
                (0, _plowJs.$get)('indexStatusResult.verdict', data) === 'PASS' && _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        _reactUiComponents.ToggablePanel.Header,
                        { className: _style2.default.panelheader },
                        _react2.default.createElement(_reactUiComponents.Icon, { icon: 'link', padded: 'right' }),
                        'Canonical'
                    ),
                    _react2.default.createElement(
                        _reactUiComponents.ToggablePanel.Contents,
                ...
                Array.isArray(referringUrls) && referringUrls.length > 0 && _react2.default.createElement('div', { className: _style2.default.hr }),
                Array.isArray(referringUrls) && referringUrls.length > 0 && _react2.default.createElement(
                    _reactUiComponents.ToggablePanel,
                    { style: 'condensed' },
                    _react2.default.createElement(
                        _reactUiComponents.ToggablePanel.Header,
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                referringUrls.map(function (url) {
                                    return _react2.default.createElement(
                                        'li',
                                        null,
                                        _react2.default.createElement(
                                            'a',
                                            { className: _style2.default.link, href: url, rel: 'nofollow,noopener', target: '_blank' },
                                            url
                                        )
                                    );
                                })
                ...
                (0, _plowJs.$get)('richResultsResult.verdict', data) === 'PASS' && _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: _style2.default.inner },
                            Array.isArray(richItems) && richItems.length > 0 && _react2.default.createElement(
                                'div',
                                null,
                                _react2.default.createElement(
                                    'ul',
                                    { className: _style2.default.list },
                                    richItems.map(function (item) {
                                        return _this2.renderRichItem(item);
                                    })
                                )
                            )
                        )
        ...
        key: 'renderVerdict',
        value: function renderVerdict(verdict, label) {
            if (!verdict) {
                return '';
            }
            ...
            return _react2.default.createElement(
                'span',
                { className: _style2.default.block },
                verdict === 'PASS' && _react2.default.createElement(_reactUiComponents.Icon, { icon: 'check', color: 'primaryBlue', size: 'lg', padded: 'right' }),
                verdict === 'NEUTRAL' && _react2.default.createElement(_reactUiComponents.Icon, { icon: 'question', color: 'warn', size: 'lg', padded: 'right' }),
                verdict === 'FAIL' && _react2.default.createElement(_reactUiComponents.Icon, { icon: 'ban', color: 'error', size: 'lg', padded: 'right' }),
                label
            );
        }
    }, {
        key: 'renderRichItem',
        value: function renderRichItem(item) {
            var _this3 = this;

            var renderIssues = function renderIssues() {
                if (!item.issues) {
                    return '';
                }
                ...
                return _react2.default.createElement(
                    ...
                    item.issues.map(function (issue) {
                        return _react2.default.createElement(
                            'ul',
                            null,
                            issue.severity === 'WARNING' && _react2.default.createElement(_reactUiComponents.Icon, { icon: 'exclamation-triangle', color: 'warn', size: 'ssm', padded: 'right' }),
                            issue.severity === 'ERROR' && _react2.default.createElement(_reactUiComponents.Icon, { icon: 'exclamation-triangle', color: 'error', size: 'sm', padded: 'right' }),
                            issue.issueMessage
                        );
                    })
                );
            ...
            return _react2.default.createElement(
                'li',
                { className: _style2.default.richitem },
                ...
                item.items && _react2.default.createElement(
                    ...
                    item.items.map(function (subItem) {
                        return _this3.renderRichItem(subItem);
                    })
                )
            );
        }
    ...
    data: _propTypes2.default.shape({
        "data": {
            "inspectionResultLink": _propTypes2.default.string,
            "indexStatusResult": _propTypes2.default.shape({
                "coverageState": _propTypes2.default.string,
                "crawledAs": _propTypes2.default.string,
                "googleCanonical": _propTypes2.default.string,
                "indexingState": _propTypes2.default.string,
                "lastCrawlTime": _propTypes2.default.string,
                "pageFetchState": _propTypes2.default.string,
                "referringUrls": _propTypes2.default.arrayOf(_propTypes2.default.string),
                "robotsTxtState": _propTypes2.default.string,
                "sitemap": _propTypes2.default.array,
                "userCanonical": _propTypes2.default.string,
                "verdict": _propTypes2.default.string
            }),
            "mobileUsabilityResult": _propTypes2.default.shape({
                "verdict": _propTypes2.default.string
            }),
            "richResultsResult": _propTypes2.default.shape({
                "verdict": _propTypes2.default.string,
                "detectedItems": _propTypes2.default.arrayOf(_propTypes2.default.shape({
                    "richResultType": _propTypes2.default.string,
...
exports.default = InspectorView;

/***/ }),

/***/ "./src/Inspector/style.css":
/*!*********************************!*\
  !*** ./src/Inspector/style.css ***!
  \*********************************/
/*! no static exports found */
...
module.exports = {"view":"style__view___EC1q2","viewbutton":"style__viewbutton___11-L6","inner":"style__inner___1OdkG","block":"style__block___2ZjJG","richitem":"style__richitem___3jT4G","panelheader":"style__panelheader___3u773","ReactCollapse--content":"style__ReactCollapse--content___m7Cpg","panelcontents":"style__panelcontents___iLkMH","hr":"style__hr___7Olvi","list":"style__list___3nmb3","link":"style__link___1i9jQ"};
...
var _index = __webpack_require__(/*! ./Inspector/index */ "./src/Inspector/index.js");
...
(0, _neosUiExtensibility2.default)('Netlogix.GoogleSearchConsoleInspector', {}, function (globalRegistry) {
